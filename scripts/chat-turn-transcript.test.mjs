...
try {
  ...
  check('the edit boxes take no ring and no accent border — a hairline that steps one shade on focus (2026-09-18)', !chat.includes('border-[var(--chat-accent)]/70') && !chat.includes('focus-within:ring-1 focus-within:ring-[var(--chat-accent)]') && (chat.match(/className="focus-self[^"]*resize-y/g) || []).length === 2 && chat.includes('focus-within:border-[var(--chat-composer-focus-border)]"') && chat.includes('resize-y border-none bg-transparent'));
