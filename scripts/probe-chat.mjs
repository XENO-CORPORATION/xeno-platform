...
const PROBES = [
  ...
  },
  {
     ...
     *
     * 98, against 104 measured: enough headroom that a transient miss does not cry wolf, tight enough
    ...
    expect: [{ min: 98 }], describe: (m) => `${m[1]} of 255 adopted components rendered (floor 98)`,
  },
  {
