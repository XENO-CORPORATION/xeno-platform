...
const PROBES = [
  ...
  },
  {
     ...
     *
     * 120, against 126 measured: enough headroom that a transient miss does not cry wolf, tight enough
    ...
    expect: [{ min: 120 }], describe: (m) => `${m[1]} of 255 adopted components rendered (floor 120)`,
  },
  {
