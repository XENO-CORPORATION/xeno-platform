...
test('transactional workforce creation and receipts on isolated PostgreSQL', async t => {
  assert.ok(connectionString, 'WORKFORCE_TEST_DATABASE_URL required; no skipped runtime proof');
