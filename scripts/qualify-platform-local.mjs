...
const BACKEND_EVIDENCE = {
  ...
  for (const [name, files] of [
    ['workspace-project-database', ['scripts/chat-workspace-scope.database.test.mjs', 'scripts/workforce-team-project-responsibility.test.mjs', 'scripts/workforce-run-admission.test.mjs', 'scripts/chat-project-database-integration.test.mjs']],
