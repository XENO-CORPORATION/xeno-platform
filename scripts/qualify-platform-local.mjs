...
const BACKEND_EVIDENCE = {
  ...
  await step('workforce-migrations', async () => {
    const files = [
      ...
      'scripts/workforce-catalog-global-view.test.mjs',
  ...
  for (const [name, files] of [
    ['workspace-project-database', ['scripts/chat-workspace-scope.database.test.mjs', 'scripts/workforce-team-project-responsibility.test.mjs', 'scripts/workforce-run-admission.test.mjs', 'scripts/workforce-run-authority.test.mjs', 'scripts/chat-project-database-integration.test.mjs']],
