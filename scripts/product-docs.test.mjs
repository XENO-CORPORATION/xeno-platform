...
const required = {
  agent: { version: '0.3.14', pages: ['introduction', 'chat-and-agent-modes', 'sessions-and-resume', 'goal-loop-handoff', 'nested-agents', 'ade-workbench', 'troubleshooting'] },
  'agent-cli': { version: '0.5.41', pages: ['introduction', 'chat-and-agent-modes', 'sessions', 'goal-loop-handoff', 'delegation', 'cli-reference', 'troubleshooting'] },
  ...
  acp: { version: '0.2.11', pages: ['introduction', 'architecture', 'coordination-extension', 'session-lifecycle', 'agent-endpoint', 'troubleshooting'] },
