        ...
        <div className="flex-1 flex flex-col px-6 pb-12 lg:px-12 xl:px-20 pt-20 lg:pt-20 xl:pt-28">
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-3 mb-6">
              <button aria-label="Continue with Google" className="flex items-center justify-center py-3 rounded-xl border border-white/[0.08] bg-white/[0.02] hover:bg-white/[0.06] hover:border-white/[0.15] transition-all group">
              ...
              <button aria-label="Continue with GitHub" className="flex items-center justify-center py-3 rounded-xl border border-white/[0.08] bg-white/[0.02] hover:bg-white/[0.06] hover:border-white/[0.15] transition-all group">
                <Github className="w-5 h-5 text-white/70 group-hover:text-white transition-colors" />
              </button>
              <button aria-label="Continue with X" className="flex items-center justify-center py-3 rounded-xl border border-white/[0.08] bg-white/[0.02] hover:bg-white/[0.06] hover:border-white/[0.15] transition-all group">
