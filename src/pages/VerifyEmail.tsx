        ...
        >
          {status === 'pending' && (
            <div>
              <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-[6px] bg-white/[0.06] border border-white/[0.08]">
                <div className="w-6 h-6 border-2 border-white/20 border-t-white/70 rounded-[3px] animate-spin" />
              </div>
              <h2 className="text-3xl font-bold tracking-tight mb-2 text-center">Verifying your email</h2>
          ...
          {status === 'success' && (
            <div className="animate-fadeSlideUp">
              ...
              <h2 className="text-3xl font-bold tracking-tight mb-2 text-center">Email verified</h2>
          ...
          {status === 'error' && (
            <div className="animate-fadeSlideUp">
              ...
              <h2 className="text-3xl font-bold tracking-tight mb-2 text-center">Verification failed</h2>
              <p className="text-white/40 leading-relaxed">{message}</p>
              ...
              {hasToken ? (
                <>
                  <button
                    ...
                    disabled={resending}
                    className={`group mt-8 w-full py-4 bg-white text-black text-sm font-semibold rounded-[6px] flex items-center justify-center gap-2 transition-all duration-300 ease-out hover:bg-white/90 hover:shadow-lg hover:shadow-white/10 active:scale-[0.98] overflow-hidden ${
