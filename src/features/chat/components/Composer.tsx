        ...
        <div className="flex items-center justify-between gap-2 px-1 pt-1">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`flex items-center gap-1.5 rounded-lg border px-2.5 py-1.5 text-[13px] font-medium transition-colors ${
                reasoningEnabled
                  ? 'border-[#ece7df]/40 bg-[#ece7df]/10 text-[#e8e3dc]'
          ...
          {isStreaming ? (
            ...
            <button
              ...
              disabled={!value.trim()}
              title="Send"
              className="flex h-9 w-9 items-center justify-center rounded-full bg-[#ece7df] text-white transition-all hover:bg-[#e8e3dc] disabled:cursor-not-allowed disabled:bg-white/10 disabled:text-white/30"
            >
