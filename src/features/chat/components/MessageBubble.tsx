        ...
        {editing ? (
          <div className="w-full max-w-[98%] md:max-w-[88%] rounded-2xl border border-[#ece7df]/40 bg-[#151515] p-2">
            ...
            <div className="flex justify-end gap-2 px-1 pt-1">
              ...
              <button
                onClick={saveEdit}
                className="rounded-md bg-[#ece7df] px-3 py-1 text-xs font-semibold text-white hover:bg-[#e8e3dc]"
              >
                Send
              </button>
            </div>
    ...
    <div className="group flex flex-col gap-1 py-3">
      ...
      {message.error && !message.content ? (
        ...
        <div className="min-w-0">
          ...
          {message.streaming && (
            <span className="ml-0.5 inline-block h-4 w-[7px] translate-y-0.5 animate-pulse rounded-sm bg-[#ece7df]" />
          )}
        </div>
      )}
