...
const components: Components = {
  ...
  a({ children, href }) {
    return (
      <a
        ...
        className="text-[#e8e3dc] underline decoration-[#ece7df]/40 underline-offset-2 hover:decoration-[#ece7df]"
      >
        {children}
      </a>
    );
  ...
  blockquote: ({ children }) => (
    <blockquote className="my-3 border-l-2 border-[#ece7df]/50 pl-3 text-white/70">{children}</blockquote>
  ),
  table: ({ children }) => (
