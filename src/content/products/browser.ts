...
const browser: ProductContent = {
  ...
  hero: {
    ...
    note: 'Version 0.5.6 for Windows — sign in with your XENO account to use it. Unsigned preview build; macOS & Linux not released yet. No CAPTCHA-solving, ever.',
  },
  trust: [
  ...
  faq: [
    ...
    { q: 'When can I use it?', a: 'Now — version 0.5.6 for Windows is in public beta. Sign in on xenostudio.ai and download it. The installer is not code-signed yet, so Windows SmartScreen asks you to confirm (More info → Run anyway). macOS and Linux have not been released.' },
  ...
  seo: {
    ...
    description: 'Real Chromium for you, and the first browser an AI agent can fully drive from a terminal — uploading and downloading files by path with no OS dialog. Saved Spaces (.xbrowser), scoped consent, private by default. Version 0.5.6 for Windows, in public beta — sign in with your XENO account.',
  },
};
