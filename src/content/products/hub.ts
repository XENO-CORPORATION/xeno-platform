...
const hub: ProductContent = {
  ...
  hero: {
    ...
    badges: ['Windows · macOS · Linux', 'Free', 'Auto-updating', 'Marketplace built in'],
    note: 'Free desktop app · signs in with your XENO account. A few panels (OS/containers, Showcase) are still preview.',
  },
  ...
  highlights: [
    ...
    { value: 'Free', label: 'Windows · macOS · Linux' },
  ],
  features: [
    {
  ...
  howItWorks: [
    { step: '1', title: 'Download & sign in', desc: 'Grab the Hub for your OS and sign in with your XENO account — device flow with a QR code.' },
  ...
  faq: [
    ...
    { q: 'Which platforms are supported?', a: 'Windows, macOS and Linux. The download button picks the build for your OS; all platforms and past versions are on the download page.' },
  ...
  seo: {
    ...
    description: 'One desktop app to install, update and launch every XENO tool — with a built-in agent, a marketplace of apps, agents and models, and one credit balance. Free for Windows, macOS and Linux.',
  },
};
