...
const sound: ProductContent = {
  ...
  faq: [
    ...
    { q: 'Which platforms and formats are supported?', a: 'The desktop app targets Windows, macOS and Linux (built on Electron). It imports WAV, FLAC, MP3, AAC, OGG and AIFF, and bounces/exports your mix from the export dialog.' },
