...
const sound: ProductContent = {
  ...
  hero: {
    ...
    badges: ['Windows desktop', 'Arrangement + Session', 'AI-native', 'Free public beta'],
    note: 'Public beta (v0.2) · Windows. macOS and Linux builds are not out yet. The core DAW works today; some instruments and effects are still landing and the .xsound format may still change.',
  },
  ...
  features: [
    ...
    },
    {
      ...
      bullets: [
        'Subtractive synth: oscillators, filter, amp & filter envelopes, noise',
        'Multi-layer sampler with velocity zones + one-shot drum pads',
        'Piano roll, step sequencer and chord detection & suggestion',
  ...
  comparison: {
    ...
    rows: [
      ...
      { feature: 'Runs on Windows, macOS and Linux', xeno: 'Windows today', them: 'Windows/Mac' },
  ...
  faq: [
    { q: 'Is XENO Sound ready for real projects?', a: 'It’s a public beta. The core DAW — Arrangement and Session views, transport, timeline, mixer, the built-in instruments and the EQ/compressor/reverb/delay effect rack, plus the AI tools — works on Windows today. Some advanced instruments and effects are still being built, and the .xsound project format may still change.' },
    ...
    { q: 'Which platforms and formats are supported?', a: 'Windows is the only build we publish today; macOS and Linux are planned (it’s built on Electron, so the path is there). It imports WAV, FLAC, MP3, AAC, OGG and AIFF, and bounces/exports your mix from the export dialog.' },
  ...
  seo: {
    ...
    description: 'Beat-making, recording, mixing and broadcast mastering in one desktop app. Arrangement + Session views, built-in synths and samplers, a Rust→WASM DSP engine, and AI denoise, stem separation, transcription and mastering. Free public beta on Windows.',
  },
};
