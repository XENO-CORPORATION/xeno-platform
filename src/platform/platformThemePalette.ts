/**
 * The platform brightness palette originally proven by Chat.
 *
 ...
 *
 * Preference, persistence, system resolution, and the runtime token bridge now live in
 * `platform/platformTheme.ts`. Chat consumes that contract like every other overview route.
 */
export type ResolvedChatTheme = 'dark' | 'dim' | 'light';
