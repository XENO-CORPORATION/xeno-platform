    ...
    menu: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'XENO Shell', href: '#', subtitle: 'Desktop shell', desc: 'A desktop shell with a real terminal & folder-level permissions.', tint: radial('rgba(200,200,210,0.20)', '#15161a') },
