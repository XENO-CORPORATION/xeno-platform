...
const PricingSection: React.FC<PricingSectionProps> = ({ onGetStarted }) => {
  ...
  const plans = [
    {
      name: 'Free',
      description: 'Your account and web workspace',
      price: { monthly: 0, yearly: 0 },
      features: [
        'Browse every product',
        'Existing installs keep working',
        'Standard-resolution managed output',
        'Community support',
        'New desktop installs require a plan',
      ],
      cta: 'Get Started',
      popular: false,
    },
    {
      name: 'Everything',
      description: 'The connected platform for individuals',
      price: { monthly: 24, yearly: 19 },
      features: [
        'Every available desktop installer',
        'Cloud sync and multi-device',
        'Cross-app workflows',
        'Agents and automation',
        'Private cloud projects',
        'Managed-inference priority',
    ...
    {
      name: 'Team',
      description: 'Everything with collaboration and workspace billing',
