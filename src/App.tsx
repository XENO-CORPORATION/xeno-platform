...
const ProductPrivacy = lazyRoute(() => import('./pages/ProductPrivacy'));
const ProductsIndex = lazyRoute(() => import('./pages/ProductsIndex'));
const ReleaseNotes = lazyRoute(() => import('./pages/ReleaseNotes'));
const Blog = lazyRoute(() => import('./pages/Blog'));
const BlogPost = lazyRoute(() => import('./pages/BlogPost'));
const Learn = lazyRoute(() => import('./pages/Learn'));
const LearnTutorial = lazyRoute(() => import('./pages/LearnTutorial'));
...
const Templates = lazyRoute(() => import('./pages/Templates'));
const ApiReference = lazyRoute(() => import('./pages/ApiReference'));
...
const Refunds = lazyRoute(() => import('./pages/Refunds'));
const Cookies = lazyRoute(() => import('./pages/Cookies'));
const Withdrawal = lazyRoute(() => import('./pages/Withdrawal'));
const Impressum = lazyRoute(() => import('./pages/Impressum'));
...
const SharedChatView = lazyRoute(() => import('./pages/SharedChatView'));
import { OSStateProvider } from './components/os/OSStateContext';
const OSAuthInterface = lazyRoute(() => import('./components/os/OSAuthInterface'));
...
const OSContainerWizard = lazyRoute(() => import('./components/os/OSContainerWizard'));
const JoinSession = lazyRoute(() => import('./components/os/JoinSession'));
...
const AuthContent = lazyRoute(() => import('./pages/AuthContent'));
const AuthRouteAlias = lazyRoute(() => import('./pages/AuthRouteAlias'));
const ActivateAccount = lazyRoute(() => import('./pages/ActivateAccount'));
const Onboarding = lazyRoute(() => import('./pages/Onboarding'));
const DownloadResume = lazyRoute(() => import('./pages/DownloadResume'));
const DeviceAuthContent = lazyRoute(() => import('./pages/DeviceAuthContent'));
const ContactContent = lazyRoute(() => import('./pages/ContactContent'));
