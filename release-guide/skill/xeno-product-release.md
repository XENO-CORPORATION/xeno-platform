...
- **Releases page** live shows the new version; **desktop** `download/win` → **`401`** for an anonymous caller (paywalled — a `302` means the gate is open). Signed in with `canDownload`, the Download button must start the download.
